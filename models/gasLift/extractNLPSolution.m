function [u_nlp_opt,plotState] = extractNLPSolution(data)
%EXTRACTNLPSOLUTION Summary of this function goes here
% 
% [OUTPUTARGS] = EXTRACTNLPSOLUTION(INPUTARGS) Explain usage here
% 
% Examples: 
% 
...
% $Author: suwartad $	$Date: 2017/11/02 14:42:01 $	$Revision: 0.1 $
