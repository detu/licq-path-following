function f = nomModel(par)
%NOMMODEL Summary of this function goes here
% 
% [OUTPUTARGS] = NOMMODEL(INPUTARGS) Explain usage here
% 
% Examples: 
% 
...
% $Author: suwartad $	$Date: 2017/10/26 14:58:24 $	$Revision: 0.1 $
