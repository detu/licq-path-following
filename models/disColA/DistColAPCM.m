function [t,states,xdot,inputs] = DistColAPCM(U,param)
%DISTCOLAPCM Summary of this function goes here
%
% Modified version of DistColAP with constant hold-ups.
% 
% [OUTPUTARGS] = DISTCOLAPCM(INPUTARGS) Explain usage here
% 
% Examples: 
% 
...
% $Author: suwartad $	$Date: 2016/02/09 16:01:39 $	$Revision: 0.1 $
