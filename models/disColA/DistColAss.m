function [t,states,xdot,inputs] = DistColAss(U)
%DISTCOLASS Summary of this function goes here
% 
% [OUTPUTARGS] = DISTCOLASS(INPUTARGS) Explain usage here
% 
% Examples: 
% 
...
% $Author: suwartad $	$Date: 2016/02/07 23:02:21 $	$Revision: 0.1 $
