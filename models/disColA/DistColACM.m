function [t,states,xdot,inputs] = DistColACM(U)
%DISTCOLACM Summary of this function goes here
%
% Modified DistColA with constant hold-up (M).
% An attempt to convexify the problem... 
%
% [OUTPUTARGS] = DISTCOLACM(INPUTARGS) Explain usage here
% 
% Examples: 
% 
...
% $Author: suwartad $	$Date: 2016/02/09 15:49:37 $	$Revision: 0.1 $
