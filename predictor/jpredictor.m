function [x_init,y_init,info] = jpredictor(problem, p_init, p_final, x_init, y_init, delta_t)
%JPREDICTOR Summary of this function goes here
% Implementation of predictor - homotopy path-following algorithm 
% from Jaschke et. al, "Fast economic model predictive control based on NLP-sensitivities" 
%
% INPUT ARGS:
% - 
% [OUTPUTARGS] = JPREDICTOR(INPUTARGS) Explain usage here
% 
% Examples: 
% 
...
% $Author: detu $	$Date: 2015/09/15 16:12:59 $	$Revision: 0.1 $
...
while ( (t <= 1) && (delta_t > 1e-6) )   % add stopping criteria delta_t not equal zero 
%while ( (t <= 2) )
