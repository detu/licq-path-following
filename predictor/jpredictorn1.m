function [x_init,y_init,info] = jpredictorn1(problem, p_init, p_final, x_init, y_init, delta_t, t_final, verbose_level)
%JPREDICTORN1 Summary of this function goes here
% 
% Modification of JPRECTORN.M added constraint on the LP problem
% [OUTPUTARGS] = JPREDICTORN1(INPUTARGS) Explain usage here
% 
% Examples: 
% 
...
% $Author: suwartad $	$Date: 2015/10/26 10:51:00 $	$Revision: 0.1 $
