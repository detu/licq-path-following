function [x_init, y_init, elapsedqp] = jpredictor_licq_pure_2(problem, p_init, p_final, x_init, y_init, delta_t, lb_init, ub_init, verbose_level, N)
...
%    fprintf('QP return: %d\n', qp_exit);
    ...
    Prob.optParam.eps_x = 1e-9;
    Prob.optParam.fTol  = 1e-9;
    Prob.optParam.xTol  = 1e-9;
    Prob.PriLevOpt = 5;
    Prob.PriLev = 1;
    startqp  = tic;
